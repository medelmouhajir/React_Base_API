        ...
        <div className="account">
            ...
            <div className="account__container">
                ...
                <div className="account__content">
                    ...
                    {success && (
                        <div className="account__message account__message--success">
                    ...
                    {error && (
                        <div className="account__message account__message--error">
                            <svg className="account__message-icon" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
                                <circle cx="12" cy="12" r="10"></circle>
                        ...
                        <div className="account__section">
                            ...
                            <div className="account__notification-list">
                                ...
                                <div className="account__notification-group">
                                    <h3 className="account__notification-title">{t('account.notifications.email')}</h3>
                                ...
                                <div className="account__notification-group">
                                    <h3 className="account__notification-title">{t('account.notifications.inApp')}</h3>
