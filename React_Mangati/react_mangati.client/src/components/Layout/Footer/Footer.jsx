            ...
            <div className="footer__container">
                <div className="footer__content">
                    ...
                    <div className="footer__section">
                        <h3 className="footer__title">Mangati</h3>
                        <p className="footer__description">
                            Empowering teams with innovative project management solutions.
                            Built for efficiency, designed for collaboration.
                        </p>
                    ...
                    <div className="footer__section">
                        ...
                        <ul className="footer__links">
                            ...
                            <li><a href="/tasks" className="footer__link">Tasks</a></li>
                            <li><a href="/team" className="footer__link">Team</a></li>
                            <li><a href="/calendar" className="footer__link">Calendar</a></li>
                            <li><a href="/reports" className="footer__link">Reports</a></li>
                        </ul>
                    </div>
                    ...
                    <div className="footer__section">
                        ...
                        <ul className="footer__links">
                            ...
                            <li><a href="/documentation" className="footer__link">Documentation</a></li>
                            <li><a href="/api" className="footer__link">API Reference</a></li>
