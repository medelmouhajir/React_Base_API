...
const LandingLayout = () => {
    ...
    return (
        <div className={`min-h-screen flex flex-col ${isDarkMode ? 'bg-gray-900 text-white' : 'bg-gray-50 text-gray-900'}`}>
            {/* Landing navbar */}
            <header className={`sticky top-0 z-30 ${isDarkMode ? 'bg-gray-800' : 'bg-white'} shadow-sm`}>
                    ...
                    <div className="flex justify-between items-center h-16">
                        ...
                        <div className="flex-shrink-0 flex items-center">
                            <img
                                ...
                                alt="Rentify"
                            />
                            <span className="ml-2 text-xl font-bold">Rentify</span>
                        </div>

                        {/* Navigation */}
                        <nav className="hidden md:flex space-x-10">
                            <a href="#features" className={`text-sm font-medium ${isDarkMode ? 'text-gray-300 hover:text-white' : 'text-gray-700 hover:text-gray-900'}`}>
                                {t('landing.features')}
                            </a>
                            <a href="#benefits" className={`text-sm font-medium ${isDarkMode ? 'text-gray-300 hover:text-white' : 'text-gray-700 hover:text-gray-900'}`}>
                                {t('landing.benefits')}
                            </a>
                            <a href="#pricing" className={`text-sm font-medium ${isDarkMode ? 'text-gray-300 hover:text-white' : 'text-gray-700 hover:text-gray-900'}`}>
                                {t('landing.pricing')}
                            </a>
                            <a href="#contact" className={`text-sm font-medium ${isDarkMode ? 'text-gray-300 hover:text-white' : 'text-gray-700 hover:text-gray-900'}`}>
                                {t('landing.contact')}
                            </a>
                        </nav>
