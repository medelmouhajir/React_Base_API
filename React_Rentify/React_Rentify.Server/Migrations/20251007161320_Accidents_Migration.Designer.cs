...
namespace React_Rentify.Server.Migrations
{
    ...
    [Migration("20251007161320_Accidents_Migration")]
    partial class Accidents_Migration
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("React_Rentify.Server.Models.Cars.Car_Image", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("React_Rentify.Server.Models.Notifications.Notification", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("React_Rentify.Server.Models.Notifications.NotificationPreference", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<bool>("GPSAlerts")
                        .HasColumnType("boolean");

                    b.Property<bool>("InvoiceNotifications")
                        .HasColumnType("boolean");
                    ...
                    b.Property<bool>("TicketNotifications")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("React_Rentify.Server.Models.Notifications.PushSubscription", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("React_Rentify.Server.Models.Reservations.Reservation", b =>
                {
                    ...
                    b.Property<DateTime?>("DelivredAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<string>("DelivredByUserId")
                        .HasColumnType("text");
                    ...
                    b.Property<string>("InvoicedByUserId")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("React_Rentify.Server.Models.Notifications.Notification", b =>
                {
                    b.HasOne("React_Rentify.Server.Models.Users.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("React_Rentify.Server.Models.Reservations.Reservation", b =>
                {
                    ...
                    b.HasOne("React_Rentify.Server.Models.Users.User", "CanceledByUser")
                        .WithMany()
                    ...
                    b.HasOne("React_Rentify.Server.Models.Users.User", "DelivredByUser")
                        .WithMany()
                        .HasForeignKey("DelivredByUserId");

                    b.HasOne("React_Rentify.Server.Models.Users.User", "InvoicedByUser")
                        .WithMany()
                        .HasForeignKey("InvoicedByUserId");

                    b.HasOne("React_Rentify.Server.Models.Users.User", "LastUpdateByUser")
                        .WithMany()
                        .HasForeignKey("LastUpdateByUserId");

                    b.HasOne("React_Rentify.Server.Models.Users.User", "ReturnedToUser")
                        .WithMany()
